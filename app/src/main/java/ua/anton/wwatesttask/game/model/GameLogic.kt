package ua.anton.wwatesttask.game.model

class GameLogic(
    private val size: Int,
    var score: Int = 0,
    state: List<IntArray> = emptyList(),
    val onScoreChange: (Int) -> Unit = {},
    var onGameWon: () -> Unit = {},
    var onGameOver: () -> Unit = {},
    val onMove: (GridTile) -> Unit = {}
) {
    private val _grid = GridTile(size, state.ifEmpty { List(size) { IntArray(size) { 0 } } })
